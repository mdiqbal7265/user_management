	...
	<div class="container-fluid">
		<div class="row">
			<div class="admin-nav p-0">
				<h4 class="text-light text-center p-2">Admin Dashboard</h4>
				...
				<div class="list-group list-group-flush">
					...
					<a href="admin-deleted-user.php" class="list-group-item text-light admin-link <?= (basename($_SERVER['PHP_SELF']) == 'admin-deleted-user.php')?"nav-active":""; ?>"><i class="fas fa-user-slash"></i>&nbsp;&nbsp;Deleted Users</a>

					<a href="assets/php/admin_action.php?export=excel" class="list-group-item text-light admin-link <?= (basename($_SERVER['PHP_SELF']) == '')?"nav-active":""; ?>"><i class="fas fa-table"></i>&nbsp;&nbsp;Export Users</a>

					
					<a href="#" class="list-group-item text-light admin-link <?= (basename($_SERVER['PHP_SELF']) == '')?"nav-active":""; ?>"><i class="fas fa-id-card"></i>&nbsp;&nbsp;Profile</a>

					<a href="#" class="list-group-item text-light admin-link <?= (basename($_SERVER['PHP_SELF']) == '')?"nav-active":""; ?>"><i class="fas fa-cog"></i>&nbsp;&nbsp;Setting</a>
				</div>
			</div>
