...
class Admin extends Database{
	...
	public function fetchAllNotes(){
		$sql = "SELECT notes.id, notes.title, notes.notes, notes.created_at, notes.updated_at, users.name, users.email FROM notes INNER JOIN users ON notes.uid = users.id";
		$stmt = $this->conn->prepare($sql);
		$stmt->execute();
		$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
	...
	// Fetch Notification
	public function fetchNotofication(){
